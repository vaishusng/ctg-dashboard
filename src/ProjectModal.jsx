...
// ---------------------------------------------------------------------------
// Shared modal for creating/editing a project, including its color —
// the color every task in the project wears on the board.
// ---------------------------------------------------------------------------
...
export default function ProjectModal({ initial, autoValue = null, onClose, onSave }) {
